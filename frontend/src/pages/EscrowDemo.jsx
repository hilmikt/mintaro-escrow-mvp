...
export default function EscrowDemo() {
  ...
  useEffect(
    () => setFundTotal(totalAllocated ? String(totalAllocated) : ""),
    [totalAllocated]
  );
  ...
  function addMilestone() {
    setMilestones([
      ...milestones,
      { amount: "0.05", title: `M${milestones.length + 1}` },
    ]);
  }
      ...
      <Section title="3) Approve Milestone (as CLIENT)">
        <div className="grid gap-3">
          <div className="text-sm">
            Milestones in this escrow: <b>{String(milestonesCount ?? "—")}</b>
          </div>
